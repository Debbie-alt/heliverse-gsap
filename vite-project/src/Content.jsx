  ...
  return (
    <main className="mt-20">
      <section className="">
        ...
        <div className="w-full md:space-x-4  flex flex-col items-center md:flex-row space-y-6  md:space-y-0 md:justify-between px-5 mt-24">
      ...
      <section className=" px-2 flex flex-col-reverse xs:flex-row mt-24 justify-between">
            <div className=" w-full xs:w-[60%] space-y-5">
            ...
            <section className="mt-24 space-y-14 ">
                  ...
                  <div className="flex flex-col md:flex-row px-3 md:px-0  justify-evenly">
                        <figure className="sectionbg p-6 w-[87vw] xs:w-[92vw] md:w-[46vw] rounded-2xl space-y-5">
                        ...
                        <figure className="mt-16 sectionbg  p-10 w-[87vw] xs:w-[92vw] md:w-[46vw] space-y-5 rounded-2xl">
            ...
            <section className=" mt-24 sectionbg mx-auto  w-[85vw] md:w-[95vw] rounded-2xl py-14  flex flex-col items-center justify-center space-y-6">
                  <h2 className=" text-center text-slate-300 font-[500]  text-[1.4rem] md:text-[1.7rem] font-sans">Supported by All Popular Browsers</h2>
                        <p className="text-gray-200 opacity-70 text-[1.1rem]  w-[80%]
                        md:w-[40%] text-center">Rest assured, Motion Art is designed to be compatible with all major web browsers.</p>
                        <img src={browsers} alt="image of different browses" className="w-[80%] md:w-[40%] " />

            </section>

            <section className="text-center mt-24">
                  <div className="mx-auto w-[90vw] md:w-[55vw] space-y-6 ">
                        <h1 className=" text-slate-300 font-sora text-[1.7rem] md:text-4xl tracking-wide font-semibold md:leading-[55px]">An All-Round Plugin With Powerful Features</h1>
                        <p className=" md:w-[80%] mx-auto text-gray-200 opacity-70  tracking-wide leading-[28px]">Whether you're a seasoned web designer or just starting out, Motion Art for Elementor seamlessly integrates with the Elementor platform, providing you with a seamless and intuitive experience.</p>
                  </div>
            </section>

            <section className="cards mt-24 w-screen space-y-5 md:space-y-0 md:space-x-5 px-3 md:px-4  flex flex-col md:flex-row ">
                  <figure className="space-y-10 py-6  rounded-2xl w-[87vw] xs:w-[92vw] md:w-1/3 sectionbg">
                        <img src={zap} alt="" />
